...
.sidebar-nav-group-label {
  ...
  /* BRAVO followup 2026-05-20 Item 9 / AA-9 — axe-core flagged the previous
     var(--text-4) (#94a3b8) at 2.56:1 contrast vs white. WCAG 2.1 AA wants
     4.5:1 for normal text. var(--text-3) (#64748b) is 4.66:1 vs white. */
  color: var(--text-3);
...
.sidebar-sublabel {
  font-size: 10px;
  font-weight: 400;
  /* BRAVO followup 2026-05-20 Item 9 / AA-9 — see comment above. */
  color: var(--text-3);
  margin-top: 1px;
}
