 ...
 *   - Floor base: example default (absolute walk-line); configure your own
 *   - Target TC: example defaults (base + bonus + year-1 equity vest); configure your own
 *   - Equity preference: equity-heavy at $130K+ base
 */

const FLOOR_BASE = 150_000;          // example default: set your own
const TARGET_TC_LOW = 200_000;       // example default: set your own
const TARGET_TC_HIGH = 275_000;      // example default: set your own
const EQUITY_PREFERENCE_BASE_FLOOR = 175_000;
const AUTO_ACTIVATE_THRESHOLD = 250_000;
