...
const SHARED_CONTEXT = `Candidate: Mitchell Williams. 18yr editorial (CNN, Al Jazeera, AJ+, HuffPost Live) + 6yr Google xGE shipping production AI for 1,000+ senior engineers. Targets: AI Solutions Architect, Forward Deployed Engineer, Applied AI Engineer, AI Enablement, AI PgM, AI-native Comms. Comp target $140K–$240K. Seattle, open to global relocation.
