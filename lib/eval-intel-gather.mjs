...
import { stripHtmlForText } from './sanitize.mjs';
...
// Centralized sanitizer (imported at top) — defeats CodeQL
// `js/incomplete-multi-character-sanitization` alerts #93 + #94.
// See lib/sanitize.mjs for full rationale.
