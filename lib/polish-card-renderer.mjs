...
<div class="dcard dcard--polish dcard--polish-never" style="border-color:${VERDICT_TO_TINT.NEVER.border};background:${VERDICT_TO_TINT.NEVER.bg};margin-bottom:10px">
  ...
  <div style="font-size:13px;color:#374151;margin-top:4px;line-height:1.55">
    <span style="font-size:16px;vertical-align:middle">⚪</span> &nbsp; <strong>Polish not yet run.</strong> Recommended before you submit.
    ...
    <details class="polish-explainer" style="margin-top:10px">
      <summary style="cursor:pointer;font-size:11.5px;color:#6b7280">What is polish?</summary>
      <div style="margin-top:6px;font-size:12px;color:#6b7280;line-height:1.55">
...
/* Dark-mode overrides — VERDICT_TO_TINT inline styles + inline color:#374151
   / color:#6b7280 don't cascade to dark mode. Without these rules the polish
   card renders light-bg + inherited-white text (invisible). Targeted only at
   inline-styled elements; per-verdict colored chips (greens/reds) untouched.
   (LEDGER-026 audit-2026-05-23 Part 3) */
body.dark .dcard--polish.dcard--polish-never {
  background: #11131c !important;
  border-color: #232737 !important;
}
body.dark .dcard--polish .dcard-label {
  color: #9a9aa6 !important;
}
body.dark .dcard--polish > div > strong,
body.dark .dcard--polish > div[style*="color:#374151"] {
  color: #fafafa !important;
}
body.dark .dcard--polish td[style*="color:#374151"] {
  color: #e5e7eb !important;
}
body.dark .dcard--polish td[style*="color:#6b7280"],
body.dark .dcard--polish ul[style*="color:#374151"] {
  color: #9ca3af !important;
}
body.dark .dcard--polish .polish-action-btn {
  background: rgba(255,255,255,0.06) !important;
  color: #fafafa;
  border-color: #2a2f3a;
}
body.dark .dcard--polish .polish-action-btn:hover {
  background: rgba(255,255,255,0.12) !important;
  border-color: #3a3f4a;
}
body.dark .dcard--polish .polish-explainer summary {
  color: #a3a3a8 !important;
}
body.dark .dcard--polish .polish-explainer > div {
  color: #a3a3a8 !important;
}
`;
}
