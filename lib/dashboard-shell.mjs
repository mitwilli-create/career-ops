...
export function getDashboardShellCSS({ scopeForStandalonePage = false } = {}) {
  ...
  // B1.3 (2026-05-20) — 3-state theme system for standalone pages.
  // Dark default (Mitchell's canonical preference). Light is opt-in via
  // the toolbar toggle — either "Light" (forced) or "Match OS" (honors
  // prefers-color-scheme: light). Persisted in localStorage; an inline
  // script in renderDashboardShell's <head> applies the saved choice
...
:root[data-theme="light"] {
  ...
  --red-fg: #b91c1c;
  --red-bg: #fee2e2;
  --focus-ring: 0 0 0 2px rgba(255,255,255,.95), 0 0 0 4px rgba(37,99,235,.55), 0 0 12px rgba(37,99,235,.18);
}
@media (prefers-color-scheme: light) {
  :root[data-theme="match-os"] {
    color-scheme: light;
    --bg: #f7f8fa;
    --surface: #ffffff;
    --surface-2: #f0f2f5;
