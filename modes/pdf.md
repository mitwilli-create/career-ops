...
Examples of legitimate reframing:
- JD says "RAG pipelines" and CV says "LLM workflows with retrieval" → reframe as "RAG pipeline design and LLM orchestration workflows"
- JD says "MLOps" and CV says "observability, evals, error handling" → reframe as "MLOps and observability: evals, error handling, cost monitoring"
- JD says "stakeholder management" and CV says "collaborated with team" → reframe as "stakeholder management across engineering, operations, and business"

**NEVER add skills the candidate doesn't have. Only reframe real experience with exact JD vocabulary.**

## HTML Template

Use the template at `cv-template.html`. Replace `{{...}}` placeholders with customized content:
