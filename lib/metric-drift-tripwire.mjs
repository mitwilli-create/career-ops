 ...
 *   3. recruiter_pipeline_density (warm-network coverage of apply-now,
 *      derived from data/network-database.json — previously sourced from
 *      dashboard-server.mjs:computeRecruiterPipelineDensity which was
 *      retired 2026-05-25)
