...
const CORPUS = [
  ...
  },
  {
    ...
    confidence: 'high',
    register: 'narrative',
    note: 'Voice OS hard rules + banned-phrase checklist. Mitchell-curated prose about his own voice.',
  },
  ...
  {
    id: 'story-voice-dna-banned-phrase-checklist-rag',
    path: 'data/human-examples/sample-14-voice-dna-banned-phrase-checklist-rag.md',
    confidence: 'high',
    register: 'narrative',
    note: 'Portfolio story: Voice DNA banned-phrase checklist RAG pipeline — ~732w, first-person narrative.',
  },
  {
  ...
  {
    id: 'story-xge-voice-dna-banned-phrase-checklist',
    path: 'data/human-examples/sample-17-xge-voice-dna-banned-phrase-checklist.md',
    confidence: 'high',
    register: 'narrative',
    note: 'Portfolio story: xGE Voice DNA banned-phrase checklist — ~741w, first-person narrative.',
  },
  {
