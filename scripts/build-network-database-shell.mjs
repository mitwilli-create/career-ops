...
/* ARCH.41 (2026-05-21) — --border-strong, --focus-ring, --radius-sm, color
   tokens — all sourced from /dashboard/css/tokens.css for all 3 theme states
   (dark, [data-theme=light], match-OS light). Single source of truth thesis;
   no page-local overrides. Q3 close-out (2026-05-21 follow-up). */
body { display: block; }
.netdb-page-wrap {
  display: grid;
