 ...
 *   - Target TC: example defaults; configure your own
 *   - Floor base: example default
...
export function computeEquityForRole(role, comp, opts = {}) {
  ...
  const assumptions = {
    ...
    default_rounds,
    floor_base: 150_000,
    target_tc_low: 200_000,
    target_tc_high: 275_000,
    note: 'Example defaults; set your own floor and target TC in config.',
  };
