...
composite_score =
  ...
  + 0.10 × comp_floor_score           # $110K floor / $250-320K target / equity-heavy preferred
...
- **3** — Between floor ($110K base) and target ($250K base); equity may compensate if structure is strong
...
**Notes:** Calibration brief tightened target to $250–320K (was $200–320K). Floor remains $110K (firm). Equity-heavy preferred above $130K base; will trade base for equity above the floor. Gate-capped per H6 (undisclosed comp at non-named-target).
