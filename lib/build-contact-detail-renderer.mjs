...
function _buildSynthesis(c) {
  ...
  // banned-phrase checklist enforced (no "delve", "leverage", "passionate", "synergy", "tapestry").
...
function _composeFallbackBody(c, overlap, cv) {
  ...
  // (deterministic — no LLM). Vision-led, plain language, no banned-phrase checklist words.
