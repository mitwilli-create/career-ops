...
export function renderPolishDcard(status, opts = {}) {
  ...
  if (!status || !status.verdict) {
    // Never-polished state — narrative-grade so a new user knows what
    // "polish" means + why it matters before clicking the action button.
    // Audit Tier 1 #2 (2026-05-20).
    return `
<div class="dcard dcard--polish dcard--polish-never" style="border-color:${VERDICT_TO_TINT.NEVER.border};background:${VERDICT_TO_TINT.NEVER.bg};margin-bottom:10px">
  ...
  <div style="font-size:13px;color:#374151;margin-top:4px;line-height:1.55">
    <span style="font-size:16px;vertical-align:middle">⚪</span> &nbsp; <strong>Not yet run.</strong> Polish is a 4-round critic &rarr; author &rarr; adjudicator &rarr; adversarial loop over your CV, cover letter, form answers, impact doc, references, and referrals — converges when every artifact clears a 0.99 confidence bar. Usually $15&ndash;$30 and 20&ndash;40 minutes per pack. Run it before you submit.
