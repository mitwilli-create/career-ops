 ...
 * - Total-comp floor $250K–$240K target, $110K absolute walk-line
...
export async function applyWealthLens(comp = {}, role = {}, opts = {}) {
  ...
  const prompt = [
    ...
    `Today is ${todayIso} PT. The candidate has a $110K absolute walk-line, $250K–$240K TC target, and prefers pre-IPO equity at frontier-AI labs (Series C+).`,
    ``,
