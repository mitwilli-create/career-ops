...
import { renderSystemBanner, renderDiscardPatternSection, renderRunwayAlert, renderCronHealthBanner } from '../lib/heartbeat-system-banner.mjs';
...
// The loudest element in the email. Priority pick per analytical action-first
...
async function renderHtmlEmail(markdownBody, meta = {}) {
  ...
  // §4 TODAY'S FOCUS — LLM coaching directive (moved down from hero per analytical priority)
