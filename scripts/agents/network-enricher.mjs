...
function _buildContactPrompt(contact) {
  return [
    ...
    `Mitchell values authentic framing over salesy framing.`,
    ...
    ``,
    `**Security Scanner respect.** Mitchell will scan for failure modes. If you're uncertain about a claim, mark it. Better an honest "couldn't verify" than a confident hallucination.`,
    ``,
